    ...
    <header>
        ...
        <div class="top-navbar container-fluid">
            <div class="menu-mb">
                ...
                <a class="<?=$a=='returnPolicy' ? 'active': ''?>" href="?c=information&a=returnPolicy">Chính sách đổi
                    trả</a>
                <a class="<?=$a=='paymentPolicy' ? 'active': ''?>" href="?c=information&a=paymentPolicy">Chính sách
                    thanh toán</a>
                <a class="<?=$a=='deliveriedPolicy' ? 'active': ''?>" href="?c=information&a=deliveriedPolicy">Chính
                    sách giao hàng</a>
                ...
                <div class="col-lg-4 col-md-4 hotline-search">
                    <div>
                        <p class="hotline-phone"><span><strong>Hotline: </strong><a
                                    href="tel:0968765936">0968765936</a></span></p>
                        <p class="hotline-email"><span><strong>Email: </strong><a
                                    href="mailto:duc11102000@gmail.com">duc11102000@gmail.com</a></span>
                        </p>
                    </div>
                    <form class="header-form" action="" method="GET">
                        <div class="input-group">
                            <input type="search" class="form-control search" placeholder="Nhập từ khóa tìm kiếm"
                                name="search" autocomplete="off" value="<?=$_GET['search'] ?? ''?>">
    ...
    <nav class="navbar navbar-default desktop-menu">
        <div class="container">
            <ul class="nav navbar-nav navbar-left hidden-sm hidden-xs">
                ...
                <li class="<?=$a=='returnPolicy' ? 'active': ''?>"><a href="?c=information&a=returnPolicy">Chính sách
                        đổi trả</a></li>
                <li class="<?=$a=='paymentPolicy' ? 'active': ''?>"><a href="?c=information&a=paymentPolicy">Chính sách
                        thanh toán</a></li>
                <li class="<?=$a=='deliveriedPolicy' ? 'active': ''?>"><a href="?c=information&a=deliveriedPolicy">Chính
                        sách giao hàng</a></li>
...
elseif (!empty($_SESSION['error'])):
    ...
    unset($_SESSION['error']);//xóa phần tử có key là error
    $class = "alert-danger";
endif;
?>

    <div class="mt-4 message alert <?=$class?>"><?=$message?></div>